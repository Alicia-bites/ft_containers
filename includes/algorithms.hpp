...
namespace ft
{
    ...
    bool    equal(typename ft::enable_if<!ft::is_integral<InputIt1>::value, InputIt1>::type first_a, InputIt1 last_a, InputIt2 first_b)
    {
    ...
    bool    equal(typename ft::enable_if<!ft::is_integral<InputIt1>::value, InputIt1>::type first_a, InputIt1 last_a, InputIt2 first_b, BinaryPredicate input_function)
    {
        for (; first_a != last_a; ++first_a, ++first_b)
        {
    ...
    template <class InputIt1, class InputIt2>
    bool lexicographical_compare(typename ft::enable_if<!ft::is_integral<InputIt1>::value, InputIt1>::type first_a, InputIt1 last_a, InputIt2 first_b, InputIt2 last_b)
    {
    ...
    bool lexicographical_compare(typename ft::enable_if<!ft::is_integral<InputIt1>::value, InputIt1>::type first_a, InputIt1 last_a, InputIt2 first_b, InputIt2 last_b, Compare comp)
    {
		while (first_a != last_a && first_b != last_b)
		{
